...
<body>
    ...
    <div class="container ">
        ...
        <div class="row ">
          ...
          <div class="col-lg-2">
              <form method="get" action="agora_isit_2.php" id="priceform" >
            <div class="btn-group-vertical" style="width:150px;"data-toggle="buttons" >
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option1" value="1.40" > 90 Λεπτά
              </label>
            </div>
          </div>
          <div class="col-lg-2">
            <div class="btn-group-vertical" style="width:150px;" data-toggle="buttons">
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option1" value="4.50">Ολοήμερο <br>(24 Ώρες)
              </label>
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option2" value="9">Πενθήμερο
              </label>
            </div>
          </div>
          <div class="col-lg-2">
            <div class="btn-group-vertical" style="width:150px;" data-toggle="buttons">
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option1" value="30"> 1 Μήνας
              </label>
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option2" value="85"> 3 Μήνες
              </label>
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option3" value="330"> 6 Μήνες
              </label>
            </div>
          </div>
          <div class="col-lg-2">
            <div class="btn-group-vertical" style="width:150px;" data-toggle="buttons">
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option1" value="1.40"> 1 Χρόνος
              </label>
            </div>
          </div>
          <div class="col-lg-2">
            <div class="btn-group-vertical" style="width:150px;" data-toggle="buttons">
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option1" value="6"> Μονή διαδρομή για αεροδρόμιο
              </label>
              <label class="btn btn-dark">
                <input type="radio" name="options" id="option2" value="10"> Διπλή διαδρομή για αεροδρόμιο
              </label>
            </div>
          </div>
         
      </div>
      <label for="exampleFormControlSelect1"style="float: left; " class="form-group">Επιλέξετε ποσότητα &nbsp&nbsp</label>
      <select class="form-control" name="ticketnum" form="priceform" style="float: left; width:200px;">
      ...
      <button type="submit" style="float: right; width:200px;" class="btn btn-success">Συνέχεια</button>
    </form>
    </div>
  </div>
        <!-- /.col-md-4 -->
