...
<link href="../ss/all.css" rel="stylesheet">
                    ...
                    <?php
                        ...
                        if(isset($_SESSION['email']) && isset($_SESSION['psw'])) {
                            ...
                            if (mysqli_num_rows($result)==0) {
                               $tempopt= $_SESSION['options'] ;
                               $temptick=   $_SESSION['ticketnum'];
                                session_destroy();
                                $_SESSION['options'] = $tempopt ;
                                $_SESSION['ticketnum'] = $temptick;
                                echo $_SESSION['psw']="";
                                echo $_SESSION['email']="";
                                echo ' <div>
                            ...
                            <small class="form-text text-muted">Ο αριθμός κάρτας βρίσκετε στο κάτω αριστερό μερος της καρτας οπώς φένεται στην παρακάτω φωτογραφία</small>
                                ...
                                echo '<br>';
                                 ...
                                 $_SESSION['idcard'] = $row['athenacard_id'];
                                echo ' <div>
                                <form method="get" id="form1" action="agora_isit_3.php">
                            <h5> Εισάγετε τον αριθμό της κάρτας</h5>
                            <hr>
            ...
            <?php
                        ...
                        if(isset($_SESSION['email']) && isset($_SESSION['psw'])) {
                            ...
                            if (mysqli_num_rows($result)==0) {
                                ...
                                <a href="javascript:history.back()">Δοκιμάστε ξανά</a>
                                </p>';
                                echo '<br>';
                             }
                            CloseCon($conn);
