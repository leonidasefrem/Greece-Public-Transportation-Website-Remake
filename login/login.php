...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top ">
      ...
      echo'<li class="nav-item">
        <a class="nav-link text-nowrap" href="#">Σύνδεση</a>
        </li>';
       } 
           ?>
    ...
    <div class="container" >
            <div class="col-4 jumbotron">
                <form method="post" action="account_settings.php">
                    <div>
                            <h5> Συνδεθείτε στον Λογαρισμό σας</h5>
                            <hr>
                    ...
                    <small id="emailHelp" class="form-text text-muted"><a href="register.php">Δημιουργία
                                Λογαρισμού</a></small>
                </form>
            </div>
        </div>
