...
<body>
  ...
  <div class="container  ">
    ...
    <div class="row align-items-center my-5  ">
      <div class="col-lg-4">
        <form method="GET" action="routes/dromologio.php" class="jumbotron bg-dark text-white" name="dromologio" id="dromologio">
          <div class="form-group border_r text-nowrap">
            <h4>Αναζήτηση Δρομολογίου</h4>
            <hr>
            <label for="source">Αναχώρηση από:</label>
            <input type="text" name="source" id="automplete-1" class="form-control " placeholder="Εισάγετε την περιοχή">
          </div>
          <div class="form-group border_r">
            <label for="destination">Άφιξη σε:</label>
            <input type="text" name="destination" id="automplete-2" class="form-control "
              placeholder="Εισάγετε την περιοχή">
          </div>
          <div class="form-group border_r">
            <label for="dromologio">Επιλέξτε Ημέρα</label>
      <select class="form-control" name="dromologio" form="dromologio" style="float: left; width:200px;">
        <option value="kathimerini">Καθημερινή</option>
        <option value="savvato">Σάββατο</option>
        <option value="kiriaki">Κυριακή</option>
      </select>
      </br></br></br>
          </div>
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-4 jumbotron bg-dark text-white">
        <div class="list-group">
          <a href="agora_isit/agora_isit_1.php" class="list-group-item list-group-item-action">
            <b> Επαναφόρτιση ηλεκτρονικού εισιτηρίου</b><i class="fas fa-angle-right "></i>
          </a>
          <a href="#" class="list-group-item list-group-item-action">Τιμές Εισιτηρίων <i
              class="fas fa-angle-right "></i></a>
          <a href="#" class="list-group-item list-group-item-action">Σημεία Έκδοσης<i
              class="fas fa-angle-right "></i></a>
          <a href="#" class="list-group-item list-group-item-action">Έκδοση Κάρτας<i
              class="fas fa-angle-right "></i></a>
        </div>
      </div>
    </div>
