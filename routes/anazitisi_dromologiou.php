  ...
  <div class="row bs-wizard align-center jumbotron" style="border-bottom:0;">
    ...
    <div class="col-lg-4"></div>
      <div class="col-lg-4 jumbotron">
        <form method="GET" action="dromologio.php" class="jumbotron bg-dark text-white">
          <div class="form-group border_r text-nowrap">
          <h4>Αναζήτηση Δρομολογίου</h4>
          <hr>
            <label for="source" > &nbsp&nbspΑναχώριση από:</label>
            <input type="text" name="source" id="automplete-1" class="form-control " 
          ...
          <div class="form-group border_r">
           ...
           <div class="form-group border_r">
              <label for="date">Επιλέξτε Ημ/νία</label>
            <input type = "date" >
            </div>
